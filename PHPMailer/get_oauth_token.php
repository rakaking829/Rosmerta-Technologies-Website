    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body pmodal-body">
          <img src="images/tcb.webp" alt="">
          <p>At Rosmerta, we believe that safer roads start with habits shaped early in life, hence Rosmerta introduces 'The Curious Bunch', a thoughtfully designed road safety doodle book that helps children understand responsible behaviour on the road, by learning, observing and interacting.</p>
          <a href="road-safety-book.html" class="btn btn-primary">Join the Waitlist</a>
        </div>
...
<!-- modalpop --><script>
  document.addEventListener('DOMContentLoaded', function () {
    setTimeout(function () {
      $('#myModal').modal('show');
    }, 10000); // 10 seconds after refresh
  });
</script><!-- end modalpop -->
 </body>
</html>
